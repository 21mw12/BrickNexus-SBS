...
class FloorResponseSchema(BaseModel):
    ...
    @classmethod
    def from_models(cls, asset_model: Any, floor_model: Any, parent_name: str | None = None, sensor_model_info: Any = None, points: Any = None, sensor_points: Any = None):
        """ 从 ORM 模型构建响应对象 """
