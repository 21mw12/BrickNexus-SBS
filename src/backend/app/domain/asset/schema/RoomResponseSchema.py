...
class RoomResponseSchema(BaseModel):
    ...
    @classmethod
    def from_models(cls, asset_model: Any, room_model: Any, parent_name: str | None = None, sensor_model_info: Any = None, points: Any = None, sensor_points: Any = None):
        """ 从 ORM 模型构建响应对象 """
        ...
        return cls(
            ...
            number=_get(room_model, "number"),
            room_purpose=_get(room_model, "room_purpose"),
            max_current=_get(room_model, "max_current"),
            manager_name=_get(room_model, "manager_name"),
        )
